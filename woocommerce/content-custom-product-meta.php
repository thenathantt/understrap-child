	...
	<section class="product-meta">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12 col-sm-6 pl-xl-0 product-meta__image">
				...
				<div class="col-12 col-sm-6 col-xl-6 align-self-center">
					<?php if ( have_rows( 'tabs' ) ) : $t = 0; $t2 = 0; ?>
						<div class="container px-0" data-aos="fade-up">
							<div class="row">
								<div class="col d-flex justify-content-center px-0">
									<ul class="nav fj-nav--product-meta mt-0" id="pills-tab" role="tablist">
										<?php while ( have_rows( 'tabs' ) ) : the_row(); $t++; ?>
											<li class="nav-item">
												<a class="nav-link <?php echo $t == 1 ? 'active' : '' ?>" id="pills-<?php echo $t; ?>-tab" data-toggle="pill" href="#pills-<?php echo $t;?>" role="tab" aria-controls="pills-<?php echo $t;?>" <?php  echo $t == 1 ? 'aria-selected="true"' : 'aria-selected="false"'; ?>><?php the_sub_field( 'heading' ); ?></a>
											</li>
										<?php endwhile; ?>
									</ul>
								</div>
								...
								<div class="col-12">
									<div class="row no-gutters mb-3">
										<div class="col-2 align-self-center">
											<span class="price-compare__content"><?php _e('Retail', 'product'); ?></span>
										</div>
										<div class="col-2 align-self-center">
											<span class="price-compare__content">$<?php the_field( 'retail_price' ); ?></span>
										</div>
										<div class="col-8">
											<div class="progress price-compare__bar">
										  		<div class="progress-bar" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
										</div>
									</div>
									<div class="row no-gutters">
										<div class="col-2 align-self-center"><span class="price-compare__content"><?php _e('Finley', 'product'); ?></span></div>
										<div class="col-2 align-self-center">
											<span class="price-compare__content">
