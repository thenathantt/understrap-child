...
function theme_enqueue_styles() {
    ...
    wp_enqueue_style( 'google-font-lato', 'https://fonts.googleapis.com/css?family=Lato:300,300i,400,400i', false );
    wp_enqueue_style('fj-font-awesome', 'https://use.fontawesome.com/releases/v5.3.1/css/all.css', false);
    wp_enqueue_style( 'hover_css', 'https://cdnjs.cloudflare.com/ajax/libs/hover.css/2.3.1/css/hover-min.css', false );
    ...
    wp_enqueue_script( 'select2_js', 'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.5/js/select2.min.js', array('jquery'), '4.0.5', false );
    wp_enqueue_style( 'slick_css', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css' );
    wp_enqueue_script( 'slick_js', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js', array('jquery'), '1.8.1', false );
    wp_enqueue_style( 'aos_css', 'https://unpkg.com/aos@2.3.1/dist/aos.css' );
    wp_enqueue_script( 'aos_js', 'https://unpkg.com/aos@2.3.1/dist/aos.js', array(), '2.3.1', false );
    wp_enqueue_style( 'swiper_css', 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/4.3.5/css/swiper.min.css' );
    wp_enqueue_script( 'swiper_js', 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/4.3.5/js/swiper.min.js', array(), '4.3.5', false );
    wp_enqueue_style( 'child-understrap-styles', get_stylesheet_directory_uri() . '/css/child-theme.css', array(), $the_theme->get( 'Version' ) );
    wp_enqueue_script( 'finley-global-js', get_stylesheet_directory_uri() . '/js/global.js', array(), $the_theme->get( 'Version' ), false );
...
/**
 * Remove version number from sripts.
 */
