...
if ( $bundled_items ) {
    ...
    foreach ( $bundled_items as $bundled_item ) {
        ...
        ?>
        <div class="row <?php echo $bundled_item_classes ?>" data-is-purchasable="<?php echo $bundled_product->is_purchasable() ? '1' : '0' ?>">
            <?php if ( !$hide_thumbnail ) : ?>
                <div class="col yith-wcpb-product-bundled-item-image">
                    <div class="yith-wcpb-product-bundled-item-image-wrapper">
                        <?php echo $bundled_product->get_image( apply_filters( 'yith_wcpb_bundled_item_thumbnail_size', 'shop_thumbnail', $bundled_item, $product ) ); ?>
                    </div>
                </div>
            <?php endif; ?>
            <div class="col yith-wcpb-product-bundled-item-data">
                ...
                <?php /* <div class="yith-wcpb-product-bundled-item-data__description"><?php echo do_shortcode( $description ); ?></div> */ ?>
                ...
                <?php if ( !$bundled_item->has_variables() ) { ?>
                    <div class="yith-wcpb-product-bundled-item-data__quantity quantity">
                        <?php if ( $min_qty < $max_qty ) { ?>
                            <input step="1" min="<?php echo $min_qty ?>" max="<?php echo $max_qty ?>"
                                   name="yith_bundle_quantity_<?php echo $item_id ?>" value="<?php echo $min_qty ?>"
                                   title="Qty"
